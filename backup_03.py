...
# 2018-12-02 kl. 15.32 tegner lilla firkant om det oenskede omraade
# dvs. koordinaterne xyz har den rigtige information
...
for contour in contours:
    ...
    x,y,w,h = rect
    cv2.rectangle(image,(x,y),(x+w+15,y+h),(255,255,255),2)
...
'''
#2018-12-02 kl. 15.21 -- tegner groen firkant om alle konturer
import numpy as np
from PIL import Image
import pytesseract
import argparse
